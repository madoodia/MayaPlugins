...
class NodeInfoCmd(OpenMaya.MPxCommand):
    """
...
def cmdCreator():
    ...
    """
    return OpenMaya.asMPxPtr(NodeInfoCmd())
...
def initializePlugin(mObj):
    ...
    """
    fnPlugin = OpenMaya.MFnPlugin(mObj, "madoodia.com", "1.0.0", "Any")
    try:
...
def uninitializePlugin(mObj):
    ...
    """
    fnPlugin = OpenMaya.MFnPlugin(mObj)
    try:
